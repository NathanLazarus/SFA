...
pricing_data[, year_descr := paste0(N_states, " Countries")]
pricing_data[year == 0, year_descr := "Equivalent\nSales Tax\n(2.7%)"]
pricing_data[year == 1, year_descr := "1 Country"]
...
year_descr_order = c("1 Country", "2 Countries", "3 Countries", "5 Countries", "10 Countries", "50 Countries", "Equivalent\nSales Tax\n(2.7%)")
