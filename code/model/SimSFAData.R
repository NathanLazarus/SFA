...
firm_1_data = data.table(state = 1, firm_id = 1, year = c(0, 1))
firm_2_data = data.table(state = c(1, 1, 2, 2), firm_id = 2, year = c(0, 1, 0, 1))
firm_3_data = data.table(state = c(2, 2, 3, 3), firm_id = 3, year = c(0, 1, 0, 1))
firm_4_data = data.table(state = c(1, 1, 2, 2, 3, 3), firm_id = 4, year = c(0, 1, 0, 1, 0, 1))
